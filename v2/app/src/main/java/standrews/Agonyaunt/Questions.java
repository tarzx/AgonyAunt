...
public class Questions {
    ...
    private Questions _nextQuestion = null;
    ...
    public Questions(int group, String question) {
    ...
    public Questions getNextQuestion(int prevGroup, String prevAnswer, String echoAnswer, boolean isEcho) {
    ...
    public void setNextQuestion(Questions nextQuestion) {
