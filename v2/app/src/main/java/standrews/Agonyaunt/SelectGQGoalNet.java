...
public class SelectGQGoalNet {
    ...
    public SelectGQGoalNet(Context context){
        this.context = context;
        System.out.println("Come to the Select Group Question Goal net");
    }
    ...
    public double[] getRate(int controlLevel, int age, boolean isMale, int prevGroup) {
        ...
        File netFile = Util.getNetFile(context, Util.SELECT_GOAL_NET_EG);
